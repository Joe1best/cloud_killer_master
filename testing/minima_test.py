...
counter = 0 # used for naming files 
for b in batches:
    counter += 1
    res = ck.MCMC_batch(results, results_16per, results_84per, b,resultsFolder) # get results
