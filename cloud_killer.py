...
class MCMC_results:
    ...
    """
    def __init__(self, mean_file, lower_file, upper_file,resultsFolder):
        mean_file = find(mean_file,'C:\\Users\\joebe\\Desktop\\Research Project 2019\\cloud_killer-master\\cloud_killer_master\\'+resultsFolder)
        lower_file = find(lower_file,'C:\\Users\\joebe\\Desktop\\Research Project 2019\\cloud_killer-master\\cloud_killer_master\\'+resultsFolder)
        upper_file =find(upper_file,'C:\\Users\\joebe\\Desktop\\Research Project 2019\\cloud_killer-master\\cloud_killer_master\\'+resultsFolder)
        print (mean_file)
...
class MCMC_batch(MCMC_results):
    ...
    the object.
    """
    def __init__(self, mean_file, lower_file, upper_file, days,resultsFolder):
        super(MCMC_batch, self).__init__(mean_file, lower_file, upper_file,resultsFolder)
